class graph_structure:
    ...
    def delete_Node(self,Node_one,Node_two):
        if Node_one in self.sq[0] and Node_two in self.sq[0] :
            Node_oneIndex,Node_twoIndex = 0,0
            for i in range(len(self.sq)):
                if Node_one == self.sq[0][i]:
                    ...
                    Node_twoIndex = i
            self.sq[Node_oneIndex][Node_twoIndex] = "0"
            self.sq[Node_twoIndex][Node_oneIndex] = "0"
        else:
            print ("is Not") 
...
graph.Adj_List()
graph.edge_List()
graph.delete_Node("C","F")
graph.delete_Node("A","B")
graph.delete_Node("C","D")
graph.Adj_matrix()
graph.Adj_List()
graph.edge_List()
graph.con_Node("A","E")
